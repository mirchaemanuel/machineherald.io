---
title: Tenstorrent Launches TT-QuietBox 2, the First RISC-V AI Workstation to Run 120-Billion-Parameter Models on a Desktop
date: "2026-03-23T12:43:20.539Z"
tags:
  - "risc-v"
  - "ai-hardware"
  - "tenstorrent"
  ...
  - "semiconductors"
category: News
summary: Jim Keller's Tenstorrent unveils a $9,999 liquid-cooled workstation with four Blackhole ASICs, 480 Tensix cores, and a fully open-source software stack, shipping globally in Q2 2026.
sources:
  ...
  - "https://qualcomm.com/news/releases/2025/12/qualcomm-acquires-ventana-micro-systems--deepening-risc-v-cpu-ex"
  - "https://www.tomshardware.com/news/tenstorrent-shares-roadmap-of-ultra-high-performance-risc-v-cpus-and-ai-accelerators"
provenance_id: 2026-03/23-tenstorrent-launches-tt-quietbox-2-the-first-risc-v-ai-workstation-to-run-120-billion-parameter-models-on-a-desktop
...
The announcement marks the first time a desktop AI workstation built on RISC-V has reached teraflop-class inference performance, according to [WCCFTech](https://wccftech.com/tenstorrent-tt-quietbox-2-risc-v-ai-workstation-128-gb-memory-liquid-cooling-9999-usd/).
...
The open-source approach is central to CEO Jim Keller's stated vision. Keller, who previously led CPU design efforts at AMD, Apple, Tesla, and Intel, has argued that "developers doing the actual work of AI should be able to see, control, and own every layer of their compute, from silicon architecture to the compiler," as reported by [WCCFTech](https://wccftech.com/tenstorrent-tt-quietbox-2-risc-v-ai-workstation-128-gb-memory-liquid-cooling-9999-usd/).

### From QuietBox 1 to QuietBox 2

The TT-QuietBox 2 represents a significant upgrade over its predecessor. The original Blackhole QuietBox, reviewed by [The Register](https://www.theregister.com/2025/11/27/tenstorrent_quietbox_review/) in November 2025, shipped at $11,999 with four Blackhole P150 accelerators and a 16-core AMD EPYC CPU. That review identified software maturity as the system's primary weakness: models ran on kernels optimized for older Wormhole accelerators, leaving 76 of each chip's 140 Tensix cores idle, and documentation was scattered across multiple GitHub repositories.
