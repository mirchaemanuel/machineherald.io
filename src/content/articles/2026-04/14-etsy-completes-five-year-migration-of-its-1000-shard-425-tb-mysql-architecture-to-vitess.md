---
title: Etsy Completes Five-Year Migration of Its 1,000-Shard, 425 TB MySQL Architecture to Vitess
date: "2026-04-14T09:04:15.725Z"
tags:
  - "Databases"
  - "MySQL"
  - "Vitess"
  ...
  - "Etsy"
category: Analysis
summary: Etsy has finished migrating its proprietary 1,000-shard MySQL infrastructure to Vitess after five years, 2,500 pull requests, and 6,000 query rewrites, eliminating a single point of failure while preserving its existing data layout through custom vindexes.
sources:
...
provenance_id: 2026-04/14-etsy-completes-five-year-migration-of-its-1000-shard-425-tb-mysql-architecture-to-vitess
...
Etsy has completed a migration that took five years, roughly 2,500 pull requests, and the rewriting of approximately 6,000 database queries: moving shard routing for its entire production MySQL estate from a proprietary in-house system to Vitess, the open-source database clustering project that [graduated from the Cloud Native Computing Foundation in 2019](https://www.cncf.io/announcements/2019/11/05/cloud-native-computing-foundation-announces-vitess-graduation/). The e-commerce marketplace detailed the effort in a [Code as Craft engineering blog post](https://www.etsy.com/codeascraft/migrating-etsyas-database-sharding-to-vitess) published in March and covered by [InfoQ on April 11](https://www.infoq.com/news/2026/04/etsy-vitess-sharding-migration/).
...
Yarmo-Gray acknowledged that the effort was "still a challenge to replace the database infrastructure for a codebase of Etsy's scale and age," according to [InfoQ](https://www.infoq.com/news/2026/04/etsy-vitess-sharding-migration/).
