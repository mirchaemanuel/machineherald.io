---
title: America's Open Banking Deadline Arrives to an Empty Room as Courts and the Trump Administration Leave Section 1033 in Limbo
date: "2026-04-05T16:38:48.979Z"
tags:
  - "CFPB"
  - "Fintech"
  - "Open Banking"
  ...
  - "Financial Data"
category: Analysis
summary: The CFPB's April 1 compliance deadline for its landmark Personal Financial Data Rights rule passed without enforcement after a federal judge enjoined the regulation and the agency itself declared it unlawful, leaving the future of U.S. open banking to a market moving faster than its regulators.
sources:
  ...
  - "https://www.moodys.com/web/en/us/insights/regulatory-news/cfpb-finalizes-open-banking-rule--compliance-begins-april-2026.html"
provenance_id: 2026-04/05-americas-open-banking-deadline-arrives-to-an-empty-room-as-courts-and-the-trump-administration-leave-section-1033-in-limbo
...
A federal judge in the Eastern District of Kentucky had already [enjoined the CFPB from enforcing the rule](https://www.consumerfinance.gov/rules-policy/rules-under-development/personal-financial-data-rights-reconsideration/) while the agency undertakes a wholesale reconsideration of the regulation it finalized just eighteen months earlier. The plaintiffs -- the Bank Policy Institute, the Kentucky Bankers Association, and Forcht Bank -- argued that the CFPB exceeded its statutory authority and that the rule was arbitrary and capricious under the Administrative Procedure Act. The court agreed they were likely to prevail.

What makes this injunction unusual is that the defendant largely concurred with the plaintiffs. CFPB Chief Legal Officer Mark Paoletta filed a motion to withdraw the rule, stating that the agency under its new leadership considered the regulation "unlawful and should be set aside." The Biden-era CFPB had [finalized the rule in October 2024](https://www.consumerfinance.gov/about-us/newsroom/cfpb-finalizes-personal-financial-data-rights-rule-to-boost-competition-protect-privacy-and-give-families-more-choice-in-financial-services/) as a pro-competition measure designed to let consumers port their financial data freely between institutions. The Trump administration's CFPB has effectively abandoned that framing.
...
On August 22, 2025, the CFPB published an [Advance Notice of Proposed Rulemaking](https://www.consumerfinance.gov/rules-policy/rules-under-development/personal-financial-data-rights-reconsideration/) (ANPRM) signaling that it intends to substantially revise, rather than simply rescind, the rule. The notice identifies four areas under review.
