---
title: Anthropic and the Pentagon Are Clashing Over What Claude Can Do in War, and the Maduro Raid Lit the Fuse
date: "2026-02-23T11:23:10.260Z"
tags:
  - "anthropic"
  - "ai-policy"
  - "military-ai"
  ...
  - "claude"
category: Analysis
summary: A dispute over AI guardrails for military use has put Anthropic's $200M Pentagon contract at risk, exposing a systemic tension between AI safety commitments and national security demands.
sources:
  ...
  - "https://thehill.com/policy/defense/5744403-anthropic-pentagon-ai-dispute/"
  - "https://www.nbcnews.com/tech/security/anthropic-ai-defense-war-venezuela-maduro-rcna259603"
provenance_id: 2026-02/23-anthropic-and-the-pentagon-are-clashing-over-what-claude-can-do-in-war-and-the-maduro-raid-lit-the-fuse
...
As [CNBC reported](https://www.cnbc.com/2026/02/18/anthropic-pentagon-ai-defense-war-surveillance.html), months of difficult negotiations have yielded little movement. Pentagon Undersecretary for Research and Engineering Emil Michael summarized the department's position bluntly: "You can't have an AI company sell AI to the Department of War and don't let it do Department of War things."

## The Venezuela Trigger

The negotiations were already tense when the Maduro raid crystallized the underlying dispute. According to reporting by [Axios](https://www.axios.com/2026/02/13/anthropic-claude-maduro-raid-pentagon) and [NBC News](https://www.nbcnews.com/tech/security/anthropic-ai-defense-war-venezuela-maduro-rcna259603), Claude was deployed via Anthropic's partnership with Palantir during the active operation — going beyond pre-operation intelligence preparation to real-time operational support, including analysis of satellite imagery.
...
An Anthropic spokesperson contested this characterization, stating the company had not discussed the use of Claude in specific operations with the Pentagon or with Palantir outside of "routine discussions on strictly technical matters," [according to NBC News](https://www.nbcnews.com/tech/security/anthropic-ai-defense-war-venezuela-maduro-rcna259603). Regardless of the precise content of the exchange, the episode accelerated an already deteriorating relationship.

## Escalation: Supply Chain Risk

Defense Secretary Pete Hegseth's response, reported by [The Washington Post](https://www.washingtonpost.com/technology/2026/02/22/pentagon-anthropic-ai-dispute/) and [Axios](https://www.axios.com/2026/02/16/anthropic-defense-department-relationship-hegseth), was to move toward labeling Anthropic a "supply chain risk" — a designation ordinarily reserved for foreign adversaries and one that would severely restrict the company's ability to work with the U.S. government across all agencies, not merely the Defense Department.

Emil Michael told Anthropic it should "cross the Rubicon," invoking the metaphor of an irrevocable commitment to a military alliance, [according to The Hill](https://thehill.com/policy/defense/5744403-anthropic-pentagon-ai-dispute/). He framed the company's guardrails as undemocratic overreach, arguing that limitations on technology use should be established through Congress and regulatory agencies — not unilaterally by private companies.

"What we're not going to do is let any one company dictate a new set of policies," Michael said, according to reporting reviewed by [CNBC](https://www.cnbc.com/2026/02/18/anthropic-pentagon-ai-defense-war-surveillance.html).

As of February 22, [The Washington Post reported](https://www.washingtonpost.com/technology/2026/02/22/pentagon-anthropic-ai-dispute/) that both sides still appear to want a deal — but on terms that currently remain irreconcilable.
...
Nor is it clear what specific mechanism would be required for Hegseth to formally designate Anthropic a supply chain risk, or whether that threshold has been legally met. Sources cited by [The Washington Post](https://www.washingtonpost.com/technology/2026/02/22/pentagon-anthropic-ai-dispute/) suggest negotiations continue, with both sides still seeking a framework that preserves some version of the commercial relationship.
